...
function validateForm(form){
	var validations = {
		'ma':{
			...
			'errmsg' : "Immobilienpreis muss innerhalb der Grenzen von 1 bis 999,999,999 sein"
		},
		'dp':{
			'minval' : 0, 'maxval' : 99, 'required' : false,
			'errmsg' : "Erster Pauschalbeitrag muss innerhalb der Grenzen von 0 bis 99 sein"
		},
		'mt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "Hypothekfrist muss von 1 bis 100 sein"
		},
		'pt':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Immobilienzins muss innerhalb der Grenzen von 0 bis 999,999 sein"
		},
		'pi':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Eigentumsversicherung muss innerhalb der Grenzen von 0 bis 99,99 sein"
		},
		'mi':{
			'minval' : 0, 'maxval' : 99.99, 'required' : false,
			'errmsg' : "PMI muss innerhalb der Grenzen von 0 bis 999,999 sein"
		},
		'la':{
			'minval' : 1, 'maxval' : 999999999, 'required' : true,
			'errmsg' : "Kredith\u00f6he muss innerhalb der Grenzen von 1 bis 999,999,999 sein"
		},
		'lt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "Kreditfrist muss innerhalb der Grenzen von 1 bis 100 sein"
		},
		'ir':{
			'minval' : 0.01, 'maxval' : 99.99, 'required' : true,
			'errmsg' : "Zinssatz muss innerhalb der Grenzen von 0.01 bis zum 999.99 sein"
		}
	};
	var toSubmit = true;
