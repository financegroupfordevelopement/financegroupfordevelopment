...
function validateForm(form){
	var validations = {
		'ma':{
			...
			'errmsg' : "\u00c7mimi i blerjes duhet te jete nga 1 deri ne 999,999,999"
		},
		'dp':{
			'minval' : 0, 'maxval' : 99, 'required' : false,
			'errmsg' : "Kesti i pare duhet te jete nga 0 deri ne 99"
		},
		'mt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "Kushti i amortizimit duhet te jete nga  1 deri ne 100"
		},
		'pt':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Taksa e prones duhet te jete nga 0 deri ne 999,999"
		},
		'pi':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Sigurimi i prones duhet te jete nga 0 deri ne 999,999"
		},
		'mi':{
			'minval' : 0, 'maxval' : 99.99, 'required' : false,
			'errmsg' : "SPA duhet te jete nga 0 deri ne 99.99"
		},
		'la':{
			'minval' : 1, 'maxval' : 999999999, 'required' : true,
			'errmsg' : "Shuma e kredise duhet te jete nga 1 deri ne 999,999,999"
		},
		'lt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "Kushti i kredise duhet te jete nga 1 deri ne 100"
		},
		'ir':{
			'minval' : 0.01, 'maxval' : 99.99, 'required' : true,
			'errmsg' : "Norma e interesit duhet te jete nga 0.01 deri 99.99"
		}
	};
	var toSubmit = true;
