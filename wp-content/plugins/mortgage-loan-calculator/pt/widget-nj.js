...
function validateForm(form){
	var validations = {
		'ma':{
			...
			'errmsg' : "Pre\u00e7o de bens imoveis deve ser nos limites de 1 a 999,999,999"
		},
		'dp':{
			'minval' : 0, 'maxval' : 99, 'required' : false,
			'errmsg' : "Contribui\u00e7\u00e3o inicial deve ser nos limites de 0 a 99"
		},
		'mt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "Prazo de hipoteca deve ser nos limites de 1 a 100"
		},
		'pt':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Imposto de bens imoveis deve ser nos limites de 0 a 999,999"
		},
		'pi':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Seguro de propriedade deve ser nos limites de 0 a 999,999"
		},
		'mi':{
			'minval' : 0, 'maxval' : 99.99, 'required' : false,
			'errmsg' : "PMI deve ser nos limites de 0 a 99,99"
		},
		'la':{
			'minval' : 1, 'maxval' : 999999999, 'required' : true,
			'errmsg' : "Montante de cr\u00e9dito deve ser nos limites de 1 a 999,999,999"
		},
		'lt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "Prazo de cr\u00e9dito deve ser nos limites de 1 a 100"
		},
		'ir':{
			'minval' : 0.01, 'maxval' : 99.99, 'required' : true,
			'errmsg' : "Taxa de Juro deve ser nos limites de 0.01 a 99.99"
		}
	};
	var toSubmit = true;
