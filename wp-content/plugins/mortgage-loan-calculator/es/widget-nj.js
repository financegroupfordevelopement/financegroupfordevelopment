...
function validateForm(form){
	var validations = {
		'ma':{
			...
			'errmsg' : "Precio de los inmuebles tiene que estar en l\u00edmites desde 1 hasta 999,999,999"
		},
		'dp':{
			'minval' : 0, 'maxval' : 99, 'required' : false,
			'errmsg' : "Contribuci\u00f3n inicial tiene que ser de 0 a 99"
		},
		'mt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "T\u00e9rmino de hipoteca tiene que ser de 1 a 100"
		},
		'pt':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Impuesto a los bienes inmuebles tiene que ser de 0 a 999,999"
		},
		'pi':{
			'minval' : 0, 'maxval' : 999999, 'required' : false,
			'errmsg' : "Seguro de bienes tiene que ser de 0 a 999,999"
		},
		'mi':{
			'minval' : 0, 'maxval' : 99.99, 'required' : false,
			'errmsg' : "PMI tiene que ser de 0 a 99,99"
		},
		'la':{
			'minval' : 1, 'maxval' : 999999999, 'required' : true,
			'errmsg' : "Tama\u00f1o del cr\u00e9dito tiene que ser de 1 a 999,999"
		},
		'lt':{
			'minval' : 1, 'maxval' : 100, 'required' : true,
			'errmsg' : "T\u00e9rmino del cr\u00e9dito tiene que ser de 1 a 100"
		},
		'ir':{
			'minval' : 0.01, 'maxval' : 99.99, 'required' : true,
			'errmsg' : "Tasa de inter\u00e9s tiene que ser de 0,01 a 99,99"
		}
	};
	var toSubmit = true;
