...
var SC$ = (function (EQ, $) {
	...
	var createMortgageScheduleTableMIT = function (schedule) {
		...
		if (L !== 0) {
			...
			strSchedule.append('<tr class=\"label rpt_footer left\"><td colspan="4">financial-calculators.com</td><td colspan="5" class=\"right\" style=\"vertical-align: text-top\">Escrow = property taxes + insurance</td></tr>');
			strSchedule.append('</tfoot>');
...
////////////////////////////////////////////////////////
	...
	var createChartsMIT = {
		...
		createLoanCharts: function (schedule) {
			...
			setTimeout(function () {createChartsMIT.initAnnualTotalChart(iframeDoc); }, 500);
			setTimeout(function () {createChartsMIT.initAccumulatedTotalChart(iframeDoc); }, 500);
			setTimeout(function () {createChartsMIT.initPIPieChart(iframeDoc); }, 500);
