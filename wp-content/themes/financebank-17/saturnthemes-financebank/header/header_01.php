...
?>
<header id="header" class="header header-01 <?php echo esc_attr( saturnthemes_financebank_get_overlay_header() ? 'header-overlay' : '' ); ?> <?php echo esc_attr( Kirki::get_option( 'saturnthemes', 'header_show_gradient' ) ? 'header-gradient' : '' ); ?>">
				...
				<div class="col-xs-12 col-md-4 end-md ">
					<ul class="header-topbar-list header-topbar-list-extra">
						<?php foreach ( (array)Kirki::get_option( 'saturnthemes', 'header_top_bar_links' ) as $saturnthemes_financebank_link ) : ?>
							<li>
								<a href="<?php echo esc_url( $saturnthemes_financebank_link['url'] ); ?>">
    ...
    <div class="header-menu-container <?php echo esc_attr( Kirki::get_option( 'saturnthemes', 'header_sticky_enable' ) != 1 ? 'affix-disabled' : ''  ); ?>" data-spy="affix" data-offset-top="197">
        <div class="container">
            <div class="row row-xs-center hidden-sm-down">
                ...
                <?php } ?>
                <div class="<?php echo esc_attr( Kirki::get_option( 'saturnthemes', 'header_request_a_quote_show' ) ? 'col-md-8 col-lg-7' : 'col-md-10' ); ?>">
                ...
                <?php if ( Kirki::get_option( 'saturnthemes', 'header_request_a_quote_show' ) ) : ?>
                    <div class="col-md-2 col-lg-3 end-xs">
                        <div class="header-request-a-quote">
                            <a href="<?php echo esc_url( Kirki::get_option( 'saturnthemes', 'header_request_a_quote_url' ) ); ?>" class="secondary-background-color-hover secondary-border-color"><?php echo esc_html( Kirki::get_option( 'header_request_a_quote_text' ) ); ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
	...
	<?php if ( get_post_meta( get_the_ID(), 'saturnthemes_financebank_header_contact_details_show', true ) == 'yes' || get_post_meta( get_the_ID(), 'saturnthemes_financebank_header_social_icons_show', true ) == 'yes' || Kirki::get_option( 'saturnthemes', 'header_contact_details_show' ) || Kirki::get_option( 'saturnthemes', 'header_social_icon_show' ) ) : ?>
				...
				<div class="row row-md-center">
					...
					<div class="col-xs-12 col-sm-2">
						<ul class="header-social-icon-list">
							...
							<?php endif; ?>
              <?php if ( Kirki::get_option( 'saturnthemes', 'header_social_icon_linkedin' ) ) : ?>
                <li>
                  <a class="header-social-icon header-social-icon-google-plus" href="<?php echo esc_url( Kirki::get_option( 'saturnthemes', 'site_social_linkedin' ) ) ?>" target="_blank">
