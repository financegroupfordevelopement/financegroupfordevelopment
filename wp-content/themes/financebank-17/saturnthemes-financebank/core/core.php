...
class saturnthemes_financebank_Core {
	...
	private function define_constants() {
		...
		$this->define( 'saturnthemes_financebank_THEME', $theme->name );
		$this->define( 'saturnthemes_financebank_THEME_VERSION', $theme->version );
	}
...
function SaturnThemesC() {
	return saturnthemes_financebank_Core::instance();
}
