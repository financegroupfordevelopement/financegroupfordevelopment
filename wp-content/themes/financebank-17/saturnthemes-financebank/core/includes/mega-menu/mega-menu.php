<?php
add_filter( 'wp_setup_nav_menu_item', 'saturnthemes_financebank_add_custom_nav_fields' );
function saturnthemes_financebank_add_custom_nav_fields( $menu_item ) {
...
add_action( 'wp_update_nav_menu_item', 'saturnthemes_financebank_update_custom_nav_fields', 10, 3 );
function saturnthemes_financebank_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
	$fields = array(
		'nolink',
		'hide',
		'menu_type',
...
add_filter( 'wp_edit_nav_menu_walker', 'saturnthemes_financebank_edit_walker', 10, 2 );
function saturnthemes_financebank_edit_walker( $walker, $menu_id ) {

	return 'saturnthemes_financebank_Walker_Nav_Menu_Edit';
