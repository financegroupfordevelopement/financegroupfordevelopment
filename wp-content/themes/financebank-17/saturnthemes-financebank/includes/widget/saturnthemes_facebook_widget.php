...
if ( ! class_exists( 'saturnthemes_financebank_Facebook_Widget' ) ) {

	add_action( 'widgets_init', 'load_saturnthemes_financebank_facebook_widget' );

	function load_saturnthemes_financebank_facebook_widget() {
		register_widget( 'saturnthemes_financebank_Facebook_Widget' );
	}

	class saturnthemes_financebank_Facebook_Widget extends WP_Widget {
		/**
		...
		function __construct() {
			parent::__construct(
				'zk_facebook',
				esc_html__( 'SaturnThemes - Facebook Page Like', 'saturnthemes-financebank' ),
				array( 'description' => esc_html__( 'Facebook Page "Like" button', 'saturnthemes-financebank' ) )
			);
		}
		...
		function form( $instance ) {
			...
			<p>
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'url' ) ); ?>"><?php esc_html_e( 'Facebook Page URL', 'saturnthemes-financebank' ) ?></label>
			...
			<p>
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Width', 'saturnthemes-financebank' ) ?></label>
			...
			<p class="help"><?php esc_html_e( 'The pixel width of the embed (Min. 180 to Max. 500)', 'saturnthemes-financebank' ); ?></p>
			<p>
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height', 'saturnthemes-financebank' ) ?></label>
				<input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"
				       name="<?php echo esc_attr( $this->get_field_name( 'height' ) ); ?>"
				       value="<?php echo esc_attr( $height ); ?>" />
			</p>
			<p class="help"><?php esc_html_e( 'The pixel height of the embed (Min. 70)', 'saturnthemes-financebank' ); ?></p>
			<p>
				...
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'use_small_header' ) ); ?>"><?php esc_html_e( 'Use Small Header', 'saturnthemes-financebank' ) ?></label>
			</p>
			<p class="help"><?php echo esc_html_e( 'Uses a smaller version of the page header', 'saturnthemes-financebank' ); ?></p>
			<p>
				...
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'adapt_to_container' ) ); ?>"><?php esc_html_e( 'Adapt to shortcode container width', 'saturnthemes-financebank' ) ?></label>
			</p>
			<p class="help"><?php echo esc_html_e( 'Shortcode will try to fit inside the container', 'saturnthemes-financebank' ); ?></p>
			<p>
				...
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'hide_cover' ) ); ?>"><?php esc_html_e( 'Hide cover photo', 'saturnthemes-financebank' ); ?></label>
			</p>
			<p class="help"><?php echo esc_html_e( 'Hide the cover photo in the header', 'saturnthemes-financebank' ); ?></p>
			<p>
				...
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'show_face' ) ); ?>"><?php esc_html_e( 'Show Friend\'s Faces', 'saturnthemes-financebank' ); ?></label>
			</p>
			<p class="help"><?php echo esc_html_e( 'Show profile photos when friends like this', 'saturnthemes-financebank' ); ?></p>
			<p>
				...
				<label
					for="<?php echo esc_attr( $this->get_field_id( 'show_posts' ) ); ?>"><?php esc_html_e( 'Show Page Posts', 'saturnthemes-financebank' ); ?></label>
			</p>
			<p class="help"><?php echo esc_html_e( 'Show posts from the Page\'s timeline', 'saturnthemes-financebank' ); ?></p>
			<?php
		}
	} // end class
} // end if