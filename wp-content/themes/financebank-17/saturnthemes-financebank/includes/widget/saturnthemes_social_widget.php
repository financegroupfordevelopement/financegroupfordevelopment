 ...
 */
if ( ! class_exists( 'saturnthemes_financebank_Social_Widget' ) ) {
    add_action('widgets_init', 'load_saturnthemes_financebank_social_widget');

    function load_saturnthemes_financebank_social_widget()
    {
        register_widget('saturnthemes_financebank_Social_Widget');
    }

    class saturnthemes_financebank_Social_Widget extends WP_Widget
    {
        ...
        {
            /* Widget settings. */
            $widget_ops = array('classname' => 'saturnthemes_financebank_social_widget',
                'description' => esc_html__('A widget that displays your social icons', 'saturnthemes-financebank' )
            );

            /* Widget control settings. */
            $control_ops = array('width' => 250, 'height' => 350, 'id_base' => 'saturnthemes_financebank_social_widget');

            /* Create the widget. */
            parent::__construct('saturnthemes_financebank_social_widget', esc_html__('SaturnThemes - Social Icons', 'saturnthemes-financebank' ), $widget_ops, $control_ops);
        }
        ...
        function form($instance)
        {
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php esc_html_e('Enter link to Facebook:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php esc_html_e('Enter link to Twitter:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('instagram')); ?>"><?php esc_html_e('Enter link to Instagram:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php esc_html_e('Enter link to Pinterest:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('vk')); ?>"><?php esc_html_e('Enter link to VK:&nbsp;&nbsp;&nbsp;&nbsp;', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('googleplus')); ?>"><?php esc_html_e('Enter link to Google Plus:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('tumblr')); ?>"><?php esc_html_e('Enter link to Tumblr:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('youtube')); ?>"><?php esc_html_e('Enter link to Youtube:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('dribbble')); ?>"><?php esc_html_e('Enter link to Dribbble:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('soundcloud')); ?>"><?php esc_html_e('Enter link to Soundcloud:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('vimeo')); ?>"><?php esc_html_e('Enter link to Vimeo:', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for = "<?php echo esc_attr($this->get_field_id('rss')); ?>"><?php esc_html_e('Enter link to RSS:', 'saturnthemes-financebank' ) ?></label>
