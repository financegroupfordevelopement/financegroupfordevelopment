<?php
if ( ! class_exists( 'saturnthemes_financebank_Instagram_Widget' ) ) {

    add_action( 'widgets_init', 'load_saturnthemes_instagram_widget' );

    function load_saturnthemes_instagram_widget() {
        register_widget( 'saturnthemes_financebank_Instagram_Widget' );
    }

    /**
     * Instagram Widget
     */
    class saturnthemes_financebank_Instagram_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                ...
                esc_html__( 'SaturnThemes - Instagram', 'saturnthemes-financebank' ),
                array( 'description' => esc_html__( 'Displays latest Instagram photos', 'saturnthemes-financebank' ) )
            );
        }
        ...
        function widget( $args, $instance ) {
            ...
            $follow_text         = isset( $instance[ 'follow_text' ] ) ? $instance[ 'follow_text' ] : esc_html__( 'Follow us on Instagram', 'saturnthemes-financebank' );
        ...
        function form( $instance ) {
            ...
            $show_likes_comments = isset( $instance[ 'show_likes_comments' ] ) ? $instance[ 'show_likes_comments' ] : '';
            $show_follow_text    = isset( $instance[ 'show_follow_text' ] ) ? $instance[ 'show_follow_text' ] : '';
            $follow_text         = isset( $instance[ 'follow_text' ] ) ? $instance[ 'follow_text' ] : esc_html__( 'Follow Us', 'saturnthemes-financebank' );
            $link_new_page       = isset( $instance[ 'link_new_page' ] ) ? $instance[ 'link_new_page' ] : '';
            ...
            <p>
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'User Name', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'number_items' ) ); ?>"><?php esc_html_e( 'Number of items', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'show_likes_comments' ) ); ?>"><?php esc_html_e( 'Show likes and comments', 'saturnthemes-financebank' ) ?></label>
            </p>
            <p>
                ...
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'show_follow_text' ) ); ?>"><?php esc_html_e( 'Show follow text', 'saturnthemes-financebank' ) ?></label>
            </p>
            <p>
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'follow_text' ) ); ?>"><?php esc_html_e( 'Text', 'saturnthemes-financebank' ) ?></label>
            ...
            <p>
                ...
                <label
                    for="<?php echo esc_attr( $this->get_field_id( 'link_new_page' ) ); ?>"><?php esc_html_e( 'Open links in new page:', 'saturnthemes-financebank' ) ?></label>
            </p>
            <strong><?php esc_html_e( 'Responsiveness', 'saturnthemes-financebank' ); ?></strong>
            <?php
        }
        ...
        public function scrape_instagram( $username, $slice ) {
            ...
            if ( false === ( $instagram = get_transient( 'instagram-media-new-' . sanitize_title_with_dashes( $username ) ) ) ) {
                ...
                if ( is_wp_error( $remote ) ) {
                    return new WP_Error( 'site_down', esc_html__( 'Unable to communicate with Instagram.', 'saturnthemes-financebank' ) );
                }

                if ( 200 != wp_remote_retrieve_response_code( $remote ) ) {
                    return new WP_Error( 'invalid_response', esc_html__( 'Instagram did not return a 200.', 'saturnthemes-financebank' ) );
                }
                ...
                if ( ! $insta_array ) {
                    return new WP_Error( 'bad_json', esc_html__( 'Instagram has returned invalid data.', 'saturnthemes-financebank' ) );
                }
                ...
                if ( isset( $insta_array[ 'entry_data' ][ 'UserProfile' ][ 0 ][ 'userMedia' ] ) ) {
                    ...
                    return new WP_Error( 'bad_josn_2', esc_html__( 'Instagram has returned invalid data.', 'saturnthemes-financebank' ) );
                }

                if ( ! is_array( $media_arr ) ) {
                    return new WP_Error( 'bad_array', esc_html__( 'Instagram has returned invalid data.', 'saturnthemes-financebank' ) );
                }
                ...
                switch ( $type ) {
                    ...
                    default:
                        foreach ( $media_arr as $media ) {
                            ...
                            $instagram[] = array(
                                'description' => esc_html__( 'Instagram Image', 'saturnthemes-financebank' ),
            ...
            if ( ! empty( $instagram ) ) {
                ...
                return new WP_Error( 'no_images', esc_html__( 'Instagram did not return any images.', 'saturnthemes-financebank' ) );
