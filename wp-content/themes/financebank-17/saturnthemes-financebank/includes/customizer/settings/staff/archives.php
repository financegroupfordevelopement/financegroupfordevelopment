<?php
$section  = 'staff_archives';
$priority = 1;

Kirki::add_field( 'saturnthemes', array(
    'type'        => 'legend',
    'settings'     => 'staff_archives_layout_legend',
...
Kirki::add_field( 'saturnthemes', array(
    'type'     => 'radio',
    'settings' => 'staff_archives_page_layout',
...
Kirki::add_field( 'saturnthemes', array(
	'type'     => 'radio',
	'settings' => 'staff_archives_content_layout',
...
Kirki::add_field( 'saturnthemes', array(
    'type'     => 'radio',
    'settings' => 'staff_archives_sidebar_position',
...
Kirki::add_field( 'saturnthemes', array(
	'type'     => 'select',
	'settings' => 'staff_archives_per_row',
	'label'    => __( 'Number of staffs per row', 'saturnthemes-financebank' ),
	'section'  => $section,
	'default'  => '3',
	'priority' => $priority++,
	'choices'  => array(
...
Kirki::add_field( 'saturnthemes', array(
    'type'        => 'legend',
    'settings'     => 'staff_archives_big_title_legend',
...
Kirki::add_field( 'saturnthemes', array(
    'type'        => 'image',
    'settings'     => 'staff_archives_big_title_image',
