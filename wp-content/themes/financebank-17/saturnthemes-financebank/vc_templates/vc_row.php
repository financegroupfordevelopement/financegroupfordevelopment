...
if ( $animation_type ) {
    $el_class .= ' wow-animation ' . esc_attr( $animation_type );
}
...
// Background overlay
if ($row_bg_overlay != '') {
    $output .= '<div class="vc-row-overlay" style="background-color: ' . $row_bg_overlay . '"></div>';
}

if ($wrap_container) {
    $output .= '<div class="container"><div class="'. esc_attr( implode( ' ', array_diff( $css_classes, array( $el_class, vc_shortcode_custom_css_class( $css ), 'vc_row-has-fill' ) ) ) ) .'">';
}
