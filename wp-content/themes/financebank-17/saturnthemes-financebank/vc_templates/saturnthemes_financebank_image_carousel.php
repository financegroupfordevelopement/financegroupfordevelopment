...
extract( $atts );
$carousel_id = 'image-carousel-' . WPBakeryShortCode_saturnthemes_financebank_Image_Carousel::getCarouselIndex();
...
<script>
    jQuery(document).ready(function ($) {
        ...
        $carousel.find('.carousel').slick({
            ...
            <?php else : ?>
                arrows: true,
                prevArrow: '<span class="fa fa-chevron-left slick-arrow-prev"></span>',
                nextArrow: '<span class="fa fa-chevron-right slick-arrow-next"></span>',
            <?php endif; ?>
