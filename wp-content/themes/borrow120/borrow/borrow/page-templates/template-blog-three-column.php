<?php
/**
 * Template Name: Template Blog Three Columns
 */
          ...
          <div class="wrapper-content bg-white pinside40">
            <div class="row">
             <?php 
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 <?php if($i%3==1){echo 'clear';} ?>">
                  <div class=" ">
                    <div class="post-block mb30 ">
                      ...
                      <div class="bg-white pinside40 outline">
                          ...
                          <p class="meta"><span class="meta-date"><?php the_time( get_option( 'date_format' ) ); ?></span><span class="meta-author"><?php esc_html_e('by ','borrow'); ?> <?php the_author_posts_link(); ?></span></p>
