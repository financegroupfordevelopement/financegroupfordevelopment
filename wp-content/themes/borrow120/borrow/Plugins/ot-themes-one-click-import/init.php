<?php
 	...
 	* Description: Import demo content with just one click
 	* Version: 1.0
 	* Author: OceanThemes
...
class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
     ...
     * @var object
     */
    public $theme_option_name = 'borrow_option'; //set theme options name here - Davis change		
	...
	public function set_demo_menus() {
		...
		$main_menu = get_term_by('name', 'Primary', 'nav_menu'); // - Davis change
